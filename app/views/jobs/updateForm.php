		...
		<span class="chat-img pull-left">
			<img src="<?= PUBLIC_ROOT . "img/profile_pictures/" . $jobs["profile_picture"]; ?>" alt="User Picture" class="img-circle profile-pic-sm">
		</span>
		<div class="chat-body clearfix">
			<div class="header">
				<strong class="primary-font"><?= $jobs["user_name"]; ?></strong>
				<small class="text-muted"><i class="fa fa-clock-o fa-fw"></i> <?= $this->timestamp($jobs["date"]);?> </small>
			</div>
			<form action="#" id="<?= "form-update-job-" . Encryption::encryptId($jobs["id"]);?>" method="post" >
				<div class="form-group">
					<label>Content <span class="text-danger">*</span></label>
					<textarea dir="auto" rows="3" maxlength="300" name="content" class="form-control" required 
						placeholder="What are you thinking?"> <?= $this->encodeHTML($jobs["content"]); ?></textarea>
