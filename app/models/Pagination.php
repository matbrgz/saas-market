...
class Pagination {
    ...
    /**
     * @access public
     * @var integer Number of items(budgets, suppliers, ..etc.) to be displayed per page
     */
    public $perPage;

    /**
     * @access public
     * @var integer Total count of items(budgets, suppliers, ..etc.)
     */
    public $totalCount;
     ...
     * @param  integer $extraOffset check product class
     * @return Pagination
     */
