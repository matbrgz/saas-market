...
class Model {
    ...
    */
     ...
     * @param  string $id
     * @return bool
     * @throws Exception if budget couldn't be deleted
     */
    public function deleteById($id){
        ...
        if($database->countRows() !== 1){
            throw new Exception ("Couldn't delete budget");
        }
    }
     ...
     * Ex:
     *  Inside suppliersController:
     *  supplier->id = $supplierId
     *  supplier->updatePost(....) -> Inside updatePost() you can get the supplier id by: $this->id
     *
     * @param  string  $id
     * @return bool
     */
