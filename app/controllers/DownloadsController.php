...
class DownloadsController extends Controller {
    ...
    public function beforeAction(){
        ...
        // So, it will be something like this: http://localhost/saas-market/downloads/download/f850749b62bf3badfb6c0?csrf_token=21eb0f2c6b4fddce8a7f3
        // $this->Security->config("validateCsrfToken", true);
    }

    /**
     * download a file provided by it's hashed name
     * the url should be something like: http://localhost/saas-market/downloads/download/f850749b62bf3ba57b6380b67c6f3096bcdfb6c0
     *
