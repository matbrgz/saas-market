...
class Request{
    ...
    */
     ...
     */
    private function mergeData(array $supplier, array $files){
        foreach($supplier as $key => $value) {
            if(is_string($value)) { $supplier[$key] = trim($value); }
        }
        return array_merge($files, $supplier);
    }
     ...
     *  * http://localhost/saas-market/public/user      returns saas-market
     *  * http://localhost/saas-market/suppliers/view/123   returns saas-market
     *
     * @return string
     */
